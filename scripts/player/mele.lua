function wpn_init() 
    ...
    vert_anim=split"56,57,58,58,57,56",
    vert_off_x=0,
    hor_anim=split"50,51,52,53,54,55",
    frame=1,
}
end
...
function player_mele_update()
    ...
    if wpn.attacking then
        plr_attack_anim()
        wpn.x, wpn.y, wpn.drx, wpn.dry = 
        plr.x + wpn.dir_boxes_off[wpn.dir][1], plr.y + wpn.dir_boxes_off[wpn.dir][2], plr.x + wpn.dir_boxes_off[wpn.dir][3], plr.y - 2 + wpn.dir_boxes_off[wpn.dir][4]
